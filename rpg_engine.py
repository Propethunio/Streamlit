...
def build_rpg_system_prompt(character, inventory_list):
    ...
    return (
        ...
        f"Na samym końcu swojej wypowiedzi dopisz sekcję z wyborami jeśli ma sens (bardzo rzadko chcemy zostawić graczowi swobodny wybór). "
        f"Muszą to być MAKSYMALNIE 3 opcje, każda od nowej linii, rozpoczynające się wyłącznie od wielkich liter z nawiasem. "
        f"Format musi być identyczny jak poniżej:\n"
        ...
        f"Nie stosuj w żadnym innym miejscu wypowiedzi tego schematu duża litera + ), "
        f"bo taki schemat automatycznie trafia do przycisku z opcjami gracza."
    )
