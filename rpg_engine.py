...
def build_rpg_system_prompt(character, inventory_list, lore_text):
    ...
    return (
        ...
        f"6.2 Gdy HP bohatera po wywołaniu modify_stats osiągnie 0 lub mniej: "
        f"napisz klimatyczną narrację śmierci (2-3 zdania), po czym zamiast opcji A/B/C napisz dokładnie 'KONIEC GRY'. "
        f"Nie dawaj opcji przeżycia, nie ratuj postaci, nie kontynuuj kampanii. "
